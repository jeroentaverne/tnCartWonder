...
//CONFIG//create_generated_clock -name DCLK -source [get_nets {CLK_BASE}] -master_clock CLK_BASE -divide_by 20 -multiply_by 1 -duty_cycle 10 -offset 9.31 -add [get_nets {Video.DCLK}]
...
// グループ
//------------------------
//CONFIG//set_clock_groups -asynchronous -group [get_clocks {CLK_3_58M}] -group [get_clocks {CLK_BASE CLK_21M}] -group [get_clocks {DCLK}] -group [get_clocks {CLK_TMDS_S CLK_TMDS_P}] -group [get_clocks {CLK_27M CLK_DAC}]
set_clock_groups -asynchronous -group [get_clocks {CLK_3_58M}] -group [get_clocks {CLK_27M CLK_BASE CLK_21M CLK_TMDS_S CLK_TMDS_P CLK_DAC}]
